/*
 * This source file contains code adapted from the Apache Stanbol test suite. 
 * Apache Stanbol is software licensed under the Apache License, Version 2.0.
 * You may obtain a copy of the License at
 *
 *   http://www.apache.org/licenses/LICENSE-2.0 see package 
 * 
 * For the original code, please see package org.apache.stanbol.commons.testing.stanbol at
 * 
...
import org.mksmart.ecapi.it.JarRunner;
import org.mksmart.ecapi.web.HomepageTest;
...
public class TestBase {
    ...
    public static synchronized void startRunnableJar() throws Exception {
        ...
        if (configuredUrl != null) {
            ...
            final JarRunner j = JarRunner.getInstance(System.getProperties());
            j.start();
            ...
            if ("true".equals(System.getProperty(KEEP_JAR_RUNNING_PROP))) {
                ...
                log.info("Note that depending on the operating system, Ctrl-C might not"
                         + " suffice to kill the process.");
                while (true) {
                    Thread.sleep(1000L);
                }
            }
